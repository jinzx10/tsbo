...
'''
A valid key-value pattern should be one of the following:

KEY    VALUE
KEY    VALUE                    # characters after the first '#' are ignored
KEY    VALUE_1 ... VALUE_N      # space-separated values are allowed
KEY
KEY                             # empty value is also allowed!
...
def read_input(fpath):
    '''
    Reads an INPUT file and returns a dictionary of key-value pairs.

    NOTE
    ----
    So far values are all strings. Further processing may be needed.
